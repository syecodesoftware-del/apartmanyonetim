...
import { SuppliersPanel, type Supplier, type Invoice, type QueueItem } from '@/components/SuppliersPanel';
...
export default async function SuppliersPage() {
  ...
  const [{ data: suppliers }, { data: invoices }, { data: queue }] = await Promise.all([
